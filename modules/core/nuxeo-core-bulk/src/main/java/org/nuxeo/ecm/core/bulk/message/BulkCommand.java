...
public class BulkCommand implements Serializable {
    ...
    // @since 11.1
    protected boolean genericScrollerType;
    ...
    public BulkCommand(Builder builder) {
        ...
        this.genericScrollerType = builder.genericScrollerType;
    }
    ...
    public static class Builder {
         ...
         * @since 11.1
         */
        public Builder useGenericScrollerType() {
            this.genericScrollerType = true;
            return this;
        }

        /**
         * Uses a document type scroller, the query must be a valid NXQL query. This is the default.
         *
         * @since 11.1
         */
        public Builder useDocumentScrollerType() {
            this.genericScrollerType = false;
            return this;
        }
